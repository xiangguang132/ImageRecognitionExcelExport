  ...
  return (
    <>
      <form onSubmit={handleSubmit} className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="bg-slate-50/50 rounded-2xl p-5 sm:p-6 border border-slate-100/50 shadow-inner">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-bold text-slate-700 tracking-wide uppercase flex items-center gap-2">
              ...
              <div className="relative group">
                <input
                  ...
                  className="w-full pl-3 pr-20 py-2.5 text-sm bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all shadow-sm group-hover:shadow-md"
                  placeholder="AC201301"
                />
                <span className="absolute right-2.5 top-1/2 -translate-y-1/2 text-[10px] text-slate-400 font-bold uppercase tracking-widest bg-slate-50 px-2 py-0.5 rounded-md border border-slate-100">
                  自动提取
                </span>
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                value={formData.name}
                onChange={handleChange}
                className="w-full px-3 py-2.5 text-sm bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all shadow-sm hover:shadow-md"
                placeholder="请输入姓名"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <input
                  ...
                  onChange={handleChange}
                  className="w-full pl-3 pr-12 py-2.5 text-sm bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all shadow-sm group-hover:shadow-md"
                  placeholder="xxx@connect.um.edu.mo"
                />
                <div className="absolute right-2.5 top-1/2 -translate-y-1/2 w-5 h-5 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 font-serif italic font-bold text-[10px]">
                  @
                </div>
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-3 py-2.5 text-sm bg-white border-2 border-rose-200/50 rounded-xl focus:outline-none focus:ring-4 focus:ring-rose-500/10 focus:border-rose-500 transition-all shadow-sm hover:shadow-md"
                placeholder="请输入专业名称"
                required
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <select
                  ...
                  className="w-full px-3 py-2.5 text-sm bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all shadow-sm appearance-none group-hover:shadow-md"
                >
              ...
              <div className="flex flex-wrap gap-3">
                {(['项目', '研究'] as const).map(option => {
                  ...
                  return (
                    <label
                      key={option}
                      className={`flex items-center gap-2 px-5 py-2.5 rounded-xl border-2 cursor-pointer transition-all duration-300 font-bold shadow-sm text-sm
                        ${selected
                          ? 'bg-gradient-to-r from-indigo-50 to-blue-50 border-indigo-500 text-indigo-700 shadow-lg shadow-indigo-500/10 -translate-y-0.5'
                          : 'bg-white border-slate-200 text-slate-600 hover:border-slate-300 hover:bg-slate-50 hover:-translate-y-0.5 hover:shadow-md'}`}
                    >
                      <div className={`w-4 h-4 rounded flex items-center justify-center border-2 transition-all duration-300
                      ...
                      <span className="text-base">{option === '项目' ? '🚀' : '🔬'}</span> {option}
                    </label>
                  )
                })}
              </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-2">
          <button
            ...
            className={`flex-1 sm:flex-none px-8 py-3 rounded-xl font-bold text-white shadow-xl transition-all duration-300 flex items-center justify-center gap-2 text-base tracking-wide
              ${isSubmitting
          ...
          <button
            ...
            onClick={handleReset}
            disabled={isSubmitting}
            className="px-6 py-3 rounded-xl font-bold text-slate-600 bg-white border-2 border-slate-200 hover:bg-slate-50 hover:border-slate-300 transition-all shadow-sm hover:shadow-md disabled:opacity-50"
          >
            重新上传
          </button>
        </div>
